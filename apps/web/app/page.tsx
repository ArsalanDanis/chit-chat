  ...
  return(
    <>
     <h1 className="display-4 text-center  mt-5">
      <span className={style.animate}>Welcome</span>
      <span className={style.animate}>to</span>
      <span className={style.animate}>my</span>
      <span className={style.animate}>project</span>
    </h1>
       {/* <h1 className=' '>All messeges will apper here</h1> */}
       {/* <Users /> */}
       {/* <div>
        <p><input onChange={(e)=>setMessage(e.target.value)} type="text" name="" id={style.inpt} placeholder="messeges" /></p> <br /><br />
        <button onClick={()=>sendMessage(message)} className={style.btn}>Send</button>
       </div>
       <div>
        {messages.map((e)=>
        (<li>{e}</li>)
       ...
       <div style={{height:'100vh'}} className='link d-flex justify-content-center align-items-center'>
        <Link href='/usersForm' className='bg-danger p-4'>CHIT-CHAT</Link>
